...
public class EnemyAI : MonoBehaviour
{
    ...
    public Vector3 attackDamage = new Vector3(1f,1f,1f);
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            collision.gameObject.transform.parent.gameObject.transform.parent.gameObject.SendMessage("ApplyDamage", new Damage(attackDamage, this.gameObject ));
            collision.gameObject.transform.parent.gameObject.transform.parent.gameObject.SendMessage("OnKnockback", transform.forward * playerKnockback);
        }
    }
